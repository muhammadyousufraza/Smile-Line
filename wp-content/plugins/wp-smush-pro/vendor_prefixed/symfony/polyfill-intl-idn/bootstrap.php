 ...
 */
use Smush_Vendor\Symfony\Polyfill\Intl\Idn as p;
...
if (\PHP_VERSION_ID < 70400) {
    if (!\function_exists('idn_to_ascii') && !\function_exists('Smush_Vendor\idn_to_ascii')) {
    ...
    if (!\function_exists('idn_to_utf8') && !\function_exists('Smush_Vendor\idn_to_utf8')) {
